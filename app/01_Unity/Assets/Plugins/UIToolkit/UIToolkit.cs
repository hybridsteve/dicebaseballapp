...
public class UIToolkit : UISpriteManager
{
	...
	public void removeElement( UISprite sprite )
	{
		...
		// HACK: Gabo edit. Since spacers where coming here because of inheritance adding safety net.
		if( sprite is UISpacer )
		{
			removeSpacerElement( sprite );
			return;
		}
	...
	// HACK: Gabo edit overloading for a spacer
	public void removeSpacerElement( UISprite spacer )
	{
		removeSpacerSprite( spacer );
	}
