...
public class UISprite : UIObject, IPositionable
{
	...
	//hack skw testing event firing, trying to figure out what's up with hierarchies not moving together
	private bool logOnTransformChange = false;
	
	public bool LogOnTransformChanged { 
		get { return logOnTransformChange; } 
		set {
			logOnTransformChange = value;	
		}
	}
	...
	public override void transformChanged()
	{
		...
		updateTransform();
		// hack skw hacking
		if ( logOnTransformChange == true )
		{
			Debug.Log( "transform changed for sprite" );	
		}
	}
